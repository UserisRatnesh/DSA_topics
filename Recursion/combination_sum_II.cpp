...
void helper(int index, vector<int> candidates, vector<int> &currcomb,
  ...
  helper(index + 1, candidates, currcomb, ans, target - candidates[index]);
  currcomb.pop_back();
...
vector<vector<int>> combinationSum(vector<int> &candidates, int target) {
  ...
  helper(0, candidates, vec, ans, target);
